...
const STANDARD_HIGH: &[(u8, &str)] = &[
    ...
    (0xE3, "ordfeminine"), (0xF1, "ae"), (0xF5, "dotlessi"),
];
...
const WINANSI_HIGH: &[(u8, &str)] = &[
    ...
    (0x9C, "oe"), (0x9E, "zcaron"), (0x9F, "Ydieresis"), (0xA1, "exclamdown"),
...
const MACROMAN_HIGH: &[(u8, &str)] = &[
    ...
    (0xAC, "dieresis"), (0xAE, "AE"), (0xAF, "Oslash"), (0xB0, "infinity"),
    (0xB1, "plusminus"), (0xB2, "lessequal"), (0xB3, "greaterequal"), (0xB4, "yen"),
    (0xB5, "mu"), (0xB6, "partialdiff"), (0xB7, "summation"), (0xB8, "product"),
    (0xB9, "pi"), (0xBA, "integral"), (0xBB, "ordfeminine"), (0xBC, "ordmasculine"),
    (0xBE, "ae"), (0xBF, "oslash"), (0xC0, "questiondown"), (0xC1, "exclamdown"),
    (0xC2, "logicalnot"), (0xC3, "radical"), (0xC4, "florin"), (0xC5, "approxequal"),
    (0xC6, "Delta"), (0xC7, "guillemotleft"), (0xC8, "guillemotright"), (0xC9, "ellipsis"),
    (0xCA, "space"), (0xCB, "Agrave"), (0xCC, "Atilde"), (0xCD, "Otilde"),
    (0xCE, "OE"), (0xCF, "oe"), (0xD0, "endash"), (0xD1, "emdash"),
    (0xD2, "quotedblleft"), (0xD3, "quotedblright"), (0xD4, "quoteleft"), (0xD5, "quoteright"),
    (0xD6, "divide"), (0xD7, "lozenge"), (0xD8, "ydieresis"), (0xD9, "Ydieresis"),
    (0xDA, "fraction"), (0xDB, "currency"), (0xDC, "guilsinglleft"), (0xDD, "guilsinglright"),
    (0xDE, "fi"), (0xDF, "fl"), (0xE0, "daggerdbl"), (0xE1, "periodcentered"),
    (0xE2, "quotesinglbase"), (0xE3, "quotedblbase"), (0xE4, "perthousand"),
    (0xE5, "Acircumflex"), (0xE6, "Ecircumflex"), (0xE7, "Aacute"), (0xE8, "Edieresis"),
    (0xE9, "Egrave"), (0xEA, "Iacute"), (0xEB, "Icircumflex"), (0xEC, "Idieresis"),
    (0xED, "Igrave"), (0xEE, "Oacute"), (0xEF, "Ocircumflex"), (0xF1, "Ograve"),
    (0xF2, "Uacute"), (0xF3, "Ucircumflex"), (0xF4, "Ugrave"), (0xF5, "dotlessi"),
    (0xF6, "circumflex"), (0xF7, "tilde"), (0xF8, "macron"), (0xF9, "breve"),
    (0xFA, "dotaccent"), (0xFB, "ring"), (0xFC, "cedilla"), (0xFD, "hungarumlaut"),
    (0xFE, "ogonek"), (0xFF, "caron"),
];

/// The Symbol font's built-in encoding, mapped straight to Unicode-bearing names.
fn symbol_name(code: u8) -> &'static str {
    match code {
        0x22 => "universal", 0x24 => "existential", 0x27 => "suchthat", 0x40 => "congruent",
        ...
        0x5A => "Zeta", 0x5C => "therefore", 0x5E => "perpendicular", 0x60 => "radicalex",
        ...
        0x7A => "zeta", 0x7E => "similar", 0xA2 => "minute", 0xA3 => "lessequal",
        0xA4 => "fraction", 0xA5 => "infinity", 0xA6 => "florin", 0xA8 => "diamond",
        0xA9 => "heart", 0xAA => "spade", 0xAB => "arrowboth", 0xAC => "arrowleft",
        0xAD => "arrowup", 0xAE => "arrowright", 0xAF => "arrowdown", 0xB0 => "degree",
        0xB1 => "plusminus", 0xB2 => "second", 0xB3 => "greaterequal", 0xB4 => "multiply",
        0xB5 => "proportional", 0xB6 => "partialdiff", 0xB7 => "bullet", 0xB8 => "divide",
        0xB9 => "notequal", 0xBA => "equivalence", 0xBB => "approxequal", 0xBC => "ellipsis",
        ...
        0xD0 => "angle", 0xD1 => "gradient", 0xD5 => "product", 0xD6 => "radical",
        0xD7 => "dotmath", 0xD8 => "logicalnot", 0xD9 => "logicaland", 0xDA => "logicalor",
        0xDB => "arrowdblboth", 0xDC => "arrowdblleft", 0xDD => "arrowdblup",
        0xDE => "arrowdblright", 0xDF => "arrowdbldown", 0xE5 => "summation",
        0xF2 => "integral",
...
pub fn glyph_name_to_unicode(name: &str) -> Option<String> {
    ...
    if let Some(base) = name.split('.').next().filter(|b| *b != name && !b.is_empty()) {
